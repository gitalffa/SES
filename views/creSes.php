                ...
                <div class="grid-container">
                     <div class="grid-x grid-padding-x">
                       <div class="large-6 cell">
                        <form action="../Models/personas/index.php" method="get" enctype="multipart/form-data" data-abide novalidate >
                ...
                <?php
                 ...
                 ?>
                  ...
                  <div class="grid-container">
                     <div class="grid-x grid-padding-x">
                       <div class="large-6 cell">
                        <form action="../Models/i/personas/ndex.php" method="get" enctype="multipart/form-data" data-abide novalidate >
                           <input type="hidden" name="idPer" value="<?php echo $idPer; ?>">
                           <input type="hidden" name="camLic">
                            <fieldset class="large-6 columns">
                                <button name="envia" class="button" type="submit" value="Submit">Subir Foto</button>
          ...
          <div class="accordion-content" data-tab-content>
            <div class="callout primary">
              ...
              <div class="media-object-section">
                ...
                <div class="thumbnail">
                <a href="../Models/personas/index.php?idPer=<?php echo $idPer; ?>"> Captura tus Datos</a>
                </div>
              </div>
            </div>
...
//SMS Semysms
 ...
 $msg = $message;  // Message
 $device = '155590';  //  Device code
 $token = 'a89325e1a6e936bd7ea29014182abe77';  //  Your token (secret)
