                    ...
                    <div class="grid-x grid-padding-x">
                      ...
                      <div class="large-3 cell">
                        <label>Ident Persona
                             ...
                             <input name="idPer" type="text"  placeholder="P1001" aria-describedby="Id de Persona"  required pattern="text"> 
                     ...
                     <!-- Nombre -->
                      <div class="large-3 cell">
                        <label>Password Pulsera
                            <input name="passPulsera1" type="Password" required aria-describedby="passPulsera"  pattern="Password">
                            <span class="form-error">
                              Por Favor Teclea el password
                            </span>
                          </label>
                          <p class="help-text" id="helppasspulseras">Password Pulsera</p>
                      </div>
                      <!-- pass 1 -->
                      <div class="large-3 cell">
                            <label>repita Password Pulsera
                            <input name="passPulsera2" type="Password" required aria-describedby="passPulsera"  pattern="Password">
                            <span class="form-error">
                              Por Favor Teclea el password
                            </span>
                          </label>
