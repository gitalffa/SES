  	...
  	<!-- /menu header --> 
        ...
        <section id="cuerpoPrincipal">
          ...
          <?php
                    ...
                    $obtener_todo_BD = "SELECT * FROM mascotas order by id";
                    ...
                    SELECT * FROM mascotas order by id LIMIT $empezar_desde, $cantidad_resultados_por_pagina");
                ...
                <div class="row">
                    <div class="column">
                        <strong><?php echo $datos['idMas']; ?></strong> 
                    </div>
