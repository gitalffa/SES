    ...
    <body>
  	...
  	<!-- /menu header --> 
        ...
        <section id="cuerpoPrincipal">
            <form action="qRIndividual.php" method="get" data-abide novalidate >
                <div data-abide-error class="alert callout" style="display: none;">
                  ...
                  <div class="row">
                      ...
                      <div class="small-12">
                      <label>Num Vehiculo
                      <select name="idPer" id="select">
                      <?php
                        $resultadoTotalVehiculos=$mysqli->query("select * from personas");
                        if(!$resultadoTotalVehiculos){
                          printf("Errormessage: $\n",$mysqli->error);
                        }else{
                          while($renglon=$resultadoTotalVehiculos->fetch_assoc()){
                            ?>
                            <option value="<?php echo $renglon['idPer']; ?>"><?php echo $renglon['idPer']." ".$renglon['nombre']." ".$renglon['apellidos']; ?></option>
