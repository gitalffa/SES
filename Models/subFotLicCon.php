    ...
    <body>
        <section id="encabezado">
            ...
            <div class="row">
                <div class="column small-6 ">
                    Sube Foto de la Lci de Conducir
                </div>
                <div class="column small-6">
  	...
  	<!-- /menu header --> 
       <section id="cuerpoPrincipal">
        <form action="regFotLicCon.php" method="post" enctype="multipart/form-data" data-abide novalidate >
            ...
            <div class="callout secundary">
                ...
                <div class="callout primary">
                     ...
                     <!--Foto -->
                          ...
                          <label>Foto
                            <input name="fotLicCon" type="file" multiple aria-describedby="Foto" required pattern="file">
                            <span class="form-error">
