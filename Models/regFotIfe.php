    ...
    <body>
  	...
  	<!-- /menu header --> 
       <section id="cuerpoPrincipal">
        ...
        $tipArcFotIfe=$_FILES['fotIfe']['type'];
        $tamArcFotIfe=$_FILES['fotIfe']['size'];
        ...
        if($tamArcFotIfe == 0){
          $foto=NULL;
                      ...
                      if(strpos($tipArcFotIfe,"jpeg")){
                        $fotIfe="../images/personas/".$idPer."fotIfe".".jpeg";
                        if (move_uploaded_file($_FILES['fotIfe']['tmp_name'], $fotIfe)){
                                ...
                                <div class="row">
                                      ...
                                      <?php 
                                       ...
                                       $updated_at=date("Y-m-d H:i:s");
                                        $inserta=$mysqli->query("update personas set fotIfe='$fotIfe',updated_at='$updated_at' where idPer='$idPer' ");
                                        if($inserta==true){
                                          ?>
