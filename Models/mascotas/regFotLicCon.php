...
<html class="no-js" lang="en" dir="ltr">
  <head>
    ...
    <title>Sube Foto Lic Conducir</title>
    ...
    <body>
  	...
  	<!-- /menu header --> 
       <section id="cuerpoPrincipal">
        ...
        $tipArcFotLicCon=$_FILES['fotLicCon']['type'];
        $tamArcFotLicCon=$_FILES['fotLicCon']['size'];
       
        if($tamArcFotLicCon == 0){
          $fotLicCon=NULL;
                      ?>
                      ...
                      if(strpos($tipArcFotLicCon,"jpeg")){
                        $fotLicCon="../images/personas/".$idPer."fotLicCon".".jpeg";
                        if (move_uploaded_file($_FILES['fotLicCon']['tmp_name'], $fotLicCon)){
                                ...
                                <div class="row">
                                      ...
                                      <?php 
                                       ...
                                       $updated_at=date("Y-m-d H:i:s");
                                        $inserta=$mysqli->query("update personas set fotCon='$fotLicCon',updated_at='$updated_at' where idPer='$idPer' ");
                                        if($inserta==true){
                                          ?>
