...
<html class="no-js" lang="en" dir="ltr">
  <head>
    ...
    <title>Sube Foto Mascotas</title>
        ...
        if($tamArcFoto == 0){
          $foto=NULL;
                      ...
                      if(strpos($tipArcFoto,"jpeg")){
                        ...
                        $foto="../../images/mascotas/".$tiempo."foto".".jpeg";
                                ...
                                <div class="row">
                                      ...
                                      <?php 
                                       ...
                                       $updated_at=date("Y-m-d H:i:s");
                                        $inserta=$mysqli->query("update mascotas set foto='$foto',updated_at='$updated_at' where idMas='$idMas' ");
                                        if($inserta==true){
                                          ?>
