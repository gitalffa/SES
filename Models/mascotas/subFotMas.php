    ...
    <body>
  	...
  	<!-- /menu header --> 
       <section id="cuerpoPrincipal">
        <form action="regFotMas.php" method="post" enctype="multipart/form-data" data-abide novalidate >
                      ...
                      <div class="large-6 cell">
                        <label>Ident Mascota
                          ...
                          ?>
                             ...
                             <input name="idMas" type="text" value="<?php echo $idMas; ?>   " placeholder="M1001" aria-describedby="Id de Mascota" required disabled="TRUE" pattern="text"> 
                           <?php
                          }else{
                              ?>
                              <input type="hidden" name="idMas" value="<?php echo $idMas; ?>   ">
