    ...
    <body>
  	...
  	<!-- /menu header --> 
       <section id="cuerpoPrincipal">
        <form action="regFotIfe.php" method="post" enctype="multipart/form-data" data-abide novalidate >
            ...
            <div class="callout secundary">
                ...
                <div class="callout primary">
                     ...
                     <!--Foto -->
                          ...
                          <label>Foto
                            <input name="fotIfe" type="file" multiple aria-describedby="Foto" required pattern="file">
                            <span class="form-error">
